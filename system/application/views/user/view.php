<div id="feature_title">
	<img src="<?php echo $profile_url; ?>" id="profile_img" width="70" height="70" />
			...
			<div class="tabContentWrapper">
				...
				<div class="tabContent">
					...
					<div id="comment_form">
						...
						<img src="'.$signedin_profile_url.'" id="profile_img" width="70" height="70" />
		...
		<div id="imageDescTabs" class="tabs fullWidthTabs">
			...
			<div class="tabContentWrapper">
				...
				<div class="tabContent">
					...
					<div><?php echo html_entity_decode($mb_desc); ?></div>
